...
export function printJobId(jobId : string | number){
    console.log(`Job id is ${jobId}`);
}

export function printUpperCaseJobId(jobId: string | number){
...
export function introToNewTeam(name: string, team : string[] | string) : string{
